...
$(function(){
    ...
    $("#startreset").on("click touchend", function(e) {
        e.preventDefault(); // Prevent any default behavior for touch
    ...
    function chooseFruit() {
        var randomFruit = Math.floor(1 + Math.random() * 8); // Generate a random fruit number
        $("#fruit1").attr('src', 'images/fruits' + randomFruit + '.png');

        // Set the size using jQuery
        $("#fruit1").css({
